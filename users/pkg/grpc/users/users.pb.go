...
func (x *ProfileUserResponse) GetRoles() []string {
	if x != nil {
		return x.Roles
	}
	return nil
...
func (x *ProfileUserResponse) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ProfileUserResponse) GetSurname() string {
	if x != nil {
		return x.Surname
	}
	return ""
...
func (x *ProfileUserResponse) GetPatronymic() string {
	if x != nil {
		return x.Patronymic
	}
	return ""
...
func (x *ProfileUserResponse) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
var file_users_users_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x22, 0x0a, 0x10, 0x50, 0x72,
	0x6f, 0x66, 0x69, 0x6c, 0x65, 0x49, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e,
	0x0a, 0x02, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x49, 0x44, 0x22, 0x8f,
	0x01, 0x0a, 0x13, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x52, 0x6f, 0x6c, 0x65, 0x73, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x52, 0x6f, 0x6c, 0x65, 0x73, 0x12, 0x12, 0x0a, 0x04,
	...
	0x32, 0x53, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x48, 0x0a, 0x0f, 0x47,
	0x65, 0x74, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x17,
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x49, 0x64,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x16, 0x5a, 0x14, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2f, 0x70,
	0x6b, 0x67, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x73, 0x62, 0x06, 0x70,
...
var file_users_users_proto_goTypes = []any{
	(*ProfileIdRequest)(nil),    // 0: users.ProfileIdRequest
	(*ProfileUserResponse)(nil), // 1: users.ProfileUserResponse
}
var file_users_users_proto_depIdxs = []int32{
	0, // 0: users.Profile.GetProfileUsers:input_type -> users.ProfileIdRequest
	1, // 1: users.Profile.GetProfileUsers:output_type -> users.ProfileUserResponse
